...
class SignUpSetPasswordViewWidget extends StatefulWidget {
  const SignUpSetPasswordViewWidget({Key? key}) : super(key: key);

  @override
  _SignUpSetPasswordViewWidgetState createState() =>
      _SignUpSetPasswordViewWidgetState();
}

class _SignUpSetPasswordViewWidgetState
    extends State<SignUpSetPasswordViewWidget> {
