                          ...
                          child: Wrap(
                            ...
                            children: [
                              FFButtonWidget(
                                ...
                                text: '${valueOrDefault<String>(
                                  columnUserProfilesRecord!.height?.toString(),
                                  '0',
                                )} sm',
                                icon: Icon(
                                  Icons.height,
                              ...
                              FFButtonWidget(
                                ...
                                text: columnUserProfilesRecord!.drinkingStatus!,
                                icon: Icon(
                              ...
                              FFButtonWidget(
                                ...
                                text: columnUserProfilesRecord!.smokingStatus!,
                                icon: Icon(
                                  Icons.smoking_rooms,
                                  size: 16,
                                ),
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final interests =
                                  columnUserProfilesRecord!.interests!.toList();
                              return Wrap(
                                spacing: 8,
                                runSpacing: 8,
                                alignment: WrapAlignment.start,
