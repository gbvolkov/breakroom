...
import 'upload_photos_view_copy_model.dart';
export 'upload_photos_view_copy_model.dart';
...
class _UploadPhotosViewCopyWidgetState
  ...
  late UploadPhotosViewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadPhotosViewCopyModel());
  }
                            ...
                            return GridView.builder(
                              ...
                              itemBuilder: (context, photosIndex) {
                                ...
                                return AddPhotoComponentWidget(
                                  key: Key(
                                      'Key1r3_${photosIndex}_of_${photos.length}'),
                                  photoUrl: photosItem,
                                );
                              },
                            );
