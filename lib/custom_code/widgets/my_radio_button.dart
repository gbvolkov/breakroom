  ...
  Widget build(BuildContext context) {
    return rb.CustomRadioButton<String>(
      ...
      radioButtonValue: (value) {
        setState(() => FFAppState().mrbSelectedValue = value.toString());
        widget.onValue();
      },
      ...
      unSelectedBorderColor: FlutterFlowTheme.of(context).lineColor,
      selectedBorderColor: FlutterFlowTheme.of(context).alternate,
      padding: 5,
      enableShape: true,
      radius: 15,
      shapeRadius: 15,
