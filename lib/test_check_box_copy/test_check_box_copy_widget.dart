...
import 'test_check_box_copy_model.dart';
export 'test_check_box_copy_model.dart';
...
class _TestCheckBoxCopyWidgetState extends State<TestCheckBoxCopyWidget> {
  late TestCheckBoxCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TestCheckBoxCopyModel());
  }
