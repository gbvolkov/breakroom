...
part of 'filters_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<FiltersRecord> _$filtersRecordSerializer =
    new _$FiltersRecordSerializer();

class _$FiltersRecordSerializer implements StructuredSerializer<FiltersRecord> {
  @override
  final Iterable<Type> types = const [FiltersRecord, _$FiltersRecord];
  @override
  final String wireName = 'FiltersRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, FiltersRecord object,
  ...
  @override
  FiltersRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new FiltersRecordBuilder();
...
class _$FiltersRecord extends FiltersRecord {
  @override
  ...
  factory _$FiltersRecord([void Function(FiltersRecordBuilder)? updates]) =>
      (new FiltersRecordBuilder()..update(updates))._build();
  ...
  _$FiltersRecord._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ageRange, r'FiltersRecord', 'ageRange');
  }

  @override
  FiltersRecord rebuild(void Function(FiltersRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FiltersRecordBuilder toBuilder() => new FiltersRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FiltersRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FiltersRecord')
...
class FiltersRecordBuilder
    implements Builder<FiltersRecord, FiltersRecordBuilder> {
  _$FiltersRecord? _$v;
  ...
  FiltersRecordBuilder() {
    FiltersRecord._initializeBuilder(this);
  }

  FiltersRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(FiltersRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$FiltersRecord;
  }

  @override
  void update(void Function(FiltersRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  FiltersRecord build() => _build();

  _$FiltersRecord _build() {
    _$FiltersRecord _$result;
    try {
      _$result = _$v ??
          new _$FiltersRecord._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'FiltersRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
