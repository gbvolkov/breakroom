...
import 'edit_drink_prefs_view_model.dart';
export 'edit_drink_prefs_view_model.dart';
...
class _EditDrinkPrefsViewWidgetState extends State<EditDrinkPrefsViewWidget> {
  late EditDrinkPrefsViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDrinkPrefsViewModel());
  }
