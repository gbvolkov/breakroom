      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'testAnythingYouWant',
              path: 'testAnythingYouWant',
              builder: (context, params) => TestAnythingYouWantWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'uploadPhotosViewCopy',
              requireAuth: true,
              builder: (context, params) => UploadPhotosViewCopyWidget(
                photos:
                    params.getParam<String>('photos', ParamType.String, true),
              ),
            ),
